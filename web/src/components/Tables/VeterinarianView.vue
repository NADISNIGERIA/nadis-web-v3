...
export default defineComponent({
  components: { VeterinarianDeclineForm, BulkEditModal },
  props: {
  ...
  setup(props) {
    ...
    } = useBulkEdit(veterinarian, useVeterinarian(), getVeterinarian)
  ...
  <div>
    ...
    <div class="w-full overflow-x-auto">
      <table class="w-2600 mb-10" id="Veterinarian_to_excel">
        <tr class="grid mt-8 mb-1 text-cool-gray-500 text-sm grid-cols-37">
        ...
        <tr
          class="grid text-cool-gray-500 w-2600 text-sm grid-cols-37"
